...
const VrCard = () => {
    const progress = 85; 
  return (
    <div className=' w-full h-[445px] flex rounded-[20px] overflow-hidden'>
        
        <div className='w-[50%] bg-[#0D0D25] p-9 flex flex-col justify-center '>
        <button className='bg-[#E40666] text-[12px] py-1 font-semibold text-white w-[80px] rounded-[5px]'>GAMING</button>
            
            <div className='text-white text-[27px] font-bold my-[20px] hover:text-[#3C3FDE] transition-colors duration-300'>Pico 4 Review: Should You Actually Buy One Instead Of Quest 2?</div>
