...
const OverlayCard = ({url,date, text}) => {
  return (
        <div className='relative md:mb-0 mb-[100px] flex-1 object-contain '>
          ...
          <div className='bg-black p-[15px] mx-[18px] absolute bottom-[-75px] left-0'>
            <p className='text-white text-[16px] font-[700] mb-[15px] hover:text-[#3C3FDE] transition-colors duration-300 cursor-pointer'>{text}</p>
